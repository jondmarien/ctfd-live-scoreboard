  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-30 mx-auto max-w-3xl px-6 py-12">
        ...
        <h1 className="mb-6 mt-4 font-quintessential text-3xl text-amber-100">About the Realm</h1>

        <article className="prose prose-invert max-w-none space-y-4 font-medievalsharp text-amber-200/80">
          <p>
          ...
          <h2 className="font-quintessential text-xl text-amber-200">Credit</h2>
